...
import './FinalCTA.comp.css';

const FinalCTA = () => {
  const { t } = useI18n();

  return (
    <section className="final-cta" aria-label={t('finalCta.aria')}>
      <div className="final-cta-inner">
        ...
        <div className="final-cta-actions">
          {WHATSAPP_URL && (
            <a className="final-cta-btn whatsapp" href={WHATSAPP_URL} target="_blank" rel="noreferrer">
          ...
          <a className="final-cta-btn" href={`mailto:${CONTACT_EMAIL}`}>
            {t('finalCta.email')}
          </a>

          <a className="final-cta-link" href="#contact">
            {t('finalCta.scroll')}
          </a>
        </div>
      </div>
